...
A browser-based 2D floor plan editor built with vanilla JavaScript and HTML5 Canvas. No frameworks, no build tools, no dependencies.

**[Try the Live Demo](https://countzero.github.io/ai_room_planner/)** -- use it directly in your browser, no download needed.
